...
$_SESSION['ambil']= $data 	= $_GET['ni'];
 $query = "select * from judul where kode_buku='$data' ";
 $tampil= mysqli_query($link,$query);
	while ($ulang=mysqli_fetch_array($tampil)){ 
 ?>
...
<form role="form" method="post" action="databuku.php" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control"  <?php echo 'value="'.$ulang['kode_buku'].'" ';?> name="kode" placeholder="Kode Buku" required>
                 
              </div>
       
              <div class="form-group">
                <label>Judul Buku</label>
                <input type="text" class="form-control" placeholder="Judul Buku" <?php echo 'value="'.$ulang['judulbuku'].'" ';?> name="judul" required>
                  
              </div>
			   <div class="form-group">
                <label>Nama Pengarang</label>
                <input type="text" class="form-control" placeholder="Nama Pengarang" <?php echo 'value="'.$ulang['namapengarang'].'" ';?> name="pengarang" required>
                  
              </div>
            
			   <div class="form-group">
                <label>Penerbit</label>
                <input type="text" class="form-control" placeholder="Penerbit" name="penerbit" <?php echo 'value="'.$ulang['kodepenerbit'].'" ';?> required >
                  
              </div>
			     
			   <div class="form-group">
                <label>Kategori</label>
				<select class="form-control" name="kategorii"><?php
    ...
    echo '<option value="'.$row['id'].'">  '.$row['nama_kategori'].'</option>';
			   ...
			   <div class="form-group">
                ...
                <input type="number" class="form-control"maxlength="4" placeholder="*Angka" name="terbit" <?php echo 'value="'.$ulang['thn_terbit'].'" ';?> required>
                    </div>
					
					<div class="form-group">
                <label>Input Pdf</label>
                <input type="file"  name="pdf"  accept=".pdf"><?php echo $ulang['pdf'];}?>
              </div><?php $_SESSION['update']=$ulang['pdf']; ?>
