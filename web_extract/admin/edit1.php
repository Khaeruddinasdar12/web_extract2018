...
<div class="wrapper">
 ...
 $query = "select * from kategori where id='$data' ";
 $tampil= mysqli_query($link,$query);
	while ($ulang=mysqli_fetch_array($tampil)){ 
 ?>
    <section class="content">
<form role="form" method="get" action="datakategori.php">
      <!-- SELECT2 EXAMPLE -->
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" <?php echo 'value="'.$ulang['nama_kategori'].'" ';?>name="namakategori"  placeholder="Kode Buku" required>
                 
              </div>
       
              <div class="form-group">
                <label>Rak</label>
                <input type="text" class="form-control"  <?php echo 'value="'.$ulang['rak'].'" ';?> placeholder="Judul Buku" name="rak" required>
